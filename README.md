...
| `catalog_obscuration` | `solar_eclipse` | Solar-disc area fraction obscured at the catalog greatest-eclipse location. |
...
| `SolarEclipse` | `has`, `type`, `jd_tdb_c1/c2/c3/c4/max`, `mag`, `catalog_mag`, `catalog_obscuration`, `obscuration`, `gamma`, `sep_max_deg`, `sun_sd_max_deg`, `moon_sd_max_deg`, `moon_dist_km`, `sun_dist_km`, `besselian` | Full solar-eclipse result. |
