...
const Item kItems[]={{"done_back",
									...
									{"menu.selftest","自检","Selftest","自己診断","자체 점검"},
									...
									{"msg.selftest_code","selftest 退出码: ","selftest exit code: ","selftest 終了コード: ","selftest 종료 코드: "},
									{"prompt.out_file",
									 "可选：输出文件路径（留空则输出到控制台）：",
									...
									{"prompt.config_key",
									 "请输入配置键（def_bsp|bsp_dir|bsp_list|default_tz|default_lang|def_fmt|def_prety）：",
									 "Enter config key (def_bsp|bsp_dir|bsp_list|default_tz|default_lang|def_fmt|def_prety): ",
									 "設定キーを入力（def_bsp|bsp_dir|bsp_list|default_tz|default_lang|def_fmt|def_prety）: ",
									 "설정 키 입력(def_bsp|bsp_dir|bsp_list|default_tz|default_lang|def_fmt|def_prety): "},
									{"prompt.config_value",
									 "请输入配置值：",
									 "Enter config value: ",
									 "設定値を入力: ",
