...
const std::array<std::pair<const char*,const char*>,175> kZhHantMap={{
	{"帮","幫"},{"毕","畢"},{"闭","閉"},{"边","邊"},{"变","變"},{"补","補"},
	{"财","財"},{"参","參"},{"仓","倉"},{"厕","廁"},{"钗","釵"},{"产","產"},
	{"肠","腸"},{"尝","嘗"},{"车","車"},{"陈","陳"},{"冲","沖"},{"厨","廚"},
	{"处","處"},{"传","傳"},{"钏","釧"},{"疮","瘡"},{"词","詞"},{"赐","賜"},
	{"从","從"},{"错","錯"},{"带","帶"},{"单","單"},{"胆","膽"},{"当","當"},
	{"灯","燈"},{"敌","敵"},{"颠","顛"},{"东","東"},{"断","斷"},{"锋","鋒"},
	{"抚","撫"},{"盖","蓋"},{"规","規"},{"贵","貴"},{"还","還"},{"号","號"},
	{"坏","壞"},{"环","環"},{"黄","黃"},{"会","會"},{"祸","禍"},{"击","擊"},
	{"机","機"},{"鸡","雞"},{"计","計"},{"继","繼"},{"间","間"},{"检","檢"},
	{"见","見"},{"剑","劍"},{"涧","澗"},{"键","鍵"},{"将","將"},{"酱","醬"},
	{"脚","腳"},{"阶","階"},{"节","節"},{"结","結"},{"仅","僅"},{"进","進"},
	{"经","經"},{"惊","驚"},{"径","徑"},{"旧","舊"},{"举","舉"},{"据","據"},
	{"绝","絕"},{"开","開"},{"库","庫"},{"匮","匱"},{"腊","臘"},{"蜡","蠟"},
	{"类","類"},{"离","離"},{"历","歷"},{"雳","靂"},{"疗","療"},{"猎","獵"},
	{"邻","鄰"},{"临","臨"},{"龙","龍"},{"娄","婁"},{"炉","爐"},{"络","絡"},
	{"马","馬"},{"码","碼"},{"满","滿"},{"门","門"},{"纳","納"},{"难","難"},
	{"内","內"},{"酿","釀"},{"农","農"},{"栖","棲"},{"启","啟"},{"气","氣"},
	{"强","強"},{"墙","墻"},{"请","請"},{"庆","慶"},{"区","區"},{"认","認"},
	{"闰","閏"},{"丧","喪"},{"扫","掃"},{"肾","腎"},{"师","師"},{"时","時"},
	{"视","視"},{"试","試"},{"饰","飾"},{"输","輸"},{"属","屬"},{"竖","豎"},
	{"数","數"},{"双","雙"},{"讼","訟"},{"诉","訴"},{"岁","歲"},{"台","臺"},
	{"体","體"},{"统","統"},{"头","頭"},{"图","圖"},{"为","為"},{"问","問"},
	{"乌","烏"},{"无","無"},{"贤","賢"},{"显","顯"},{"乡","鄉"},{"响","響"},
	{"项","項"},{"谢","謝"},{"凶","兇"},{"虚","虛"},{"续","續"},{"选","選"},
	{"学","學"},{"询","詢"},{"阳","陽"},{"杨","楊"},{"养","養"},{"药","藥"},
	{"医","醫"},{"驿","驛"},{"营","營"},{"鱼","魚"},{"与","與"},{"语","語"},
	{"远","遠"},{"运","運"},{"酝","醞"},{"灾","災"},{"载","載"},{"攒","攢"},
	{"则","則"},{"择","擇"},{"张","張"},{"长","長"},{"蛰","蟄"},{"针","針"},
	{"轸","軫"},{"织","織"},{"执","執"},{"种","種"},{"诸","諸"},{"猪","豬"},
	{"转","轉"},
}};
