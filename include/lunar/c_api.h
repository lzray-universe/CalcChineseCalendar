...
LUNAR_API int LUNAR_CALL lunar_cmd_export(int argc,const char*const*argv);
...
LUNAR_API int LUNAR_CALL lunar_cmd_eclipse(int argc,const char*const*argv);
...
LUNAR_API int LUNAR_CALL lunar_use_export(void);
...
LUNAR_API int LUNAR_CALL lunar_use_eclipse(void);
